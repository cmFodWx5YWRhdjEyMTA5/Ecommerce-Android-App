...
object Constants {
    ...
    object Config {
         const  val DEFAULT_URL = "https://ecommerce-store-2.000webhostapp.com/"
         const  val BASE_URL= DEFAULT_URL+"wp-json/"
         const val consumerKey = "S5SBiXJzJd85"
         const val consumerSecret = "yQkqaPYG0N4q6PK1wKjqOzluAZLPHxszY13VfzjR0jUIOVuN"
         const val token = "A3UG6XqwVi2KaZPTZZEtXBF5"
         const val tokenSecret = "tDxucmdzoFSyVXnzTRwm9chSAu2fMprnWP6It6iHB1oAMm7m"
