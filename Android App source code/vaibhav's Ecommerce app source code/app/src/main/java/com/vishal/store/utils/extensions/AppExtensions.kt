package com.vishal.store.utils.extensions
...
import com.vishal.store.WooBoxApp
import com.vishal.store.WooBoxApp.Companion.getAppInstance
import com.vishal.store.WooBoxApp.Companion.noInternetDialog
import com.vishal.store.activity.DashBoardActivity
import com.vishal.store.activity.ProductDetailActivity
import com.vishal.store.models.*
import com.vishal.store.utils.Constants
import com.vishal.store.utils.Constants.AppBroadcasts.ADDRESS_UPDATE
import com.vishal.store.utils.Constants.AppBroadcasts.CART_COUNT_CHANGE
import com.vishal.store.utils.Constants.AppBroadcasts.ORDER_COUNT_CHANGE
import com.vishal.store.utils.Constants.AppBroadcasts.PROFILE_UPDATE
import com.vishal.store.utils.Constants.AppBroadcasts.WISHLIST_UPDATE
import com.vishal.store.utils.Constants.KeyIntent.DATA
import com.vishal.store.utils.Constants.PLAY_STORE_URL_PREFIX
import com.vishal.store.utils.Constants.SharedPref.CART_DATA
import com.vishal.store.utils.Constants.SharedPref.CATEGORY_DATA
import com.vishal.store.utils.Constants.SharedPref.DEFAULT_CURRENCY
import com.vishal.store.utils.Constants.SharedPref.IS_LOGGED_IN
import com.vishal.store.utils.Constants.SharedPref.IS_SOCIAL_LOGIN
import com.vishal.store.utils.Constants.SharedPref.KEY_ADDRESS
import com.vishal.store.utils.Constants.SharedPref.KEY_CART_COUNT
import com.vishal.store.utils.Constants.SharedPref.KEY_DASHBOARD
import com.vishal.store.utils.Constants.SharedPref.KEY_ORDERS
import com.vishal.store.utils.Constants.SharedPref.KEY_RECENTS
import com.vishal.store.utils.Constants.SharedPref.KEY_USER_ADDRESS
import com.vishal.store.utils.Constants.SharedPref.KEY_WISHLIST_COUNT
import com.vishal.store.utils.Constants.SharedPref.SLIDER_IMAGES_DATA
import com.vishal.store.utils.Constants.SharedPref.THEME_COLOR
import com.vishal.store.utils.Constants.SharedPref.USER_DISPLAY_NAME
import com.vishal.store.utils.Constants.SharedPref.USER_EMAIL
import com.vishal.store.utils.Constants.SharedPref.USER_FIRST_NAME
import com.vishal.store.utils.Constants.SharedPref.USER_ID
import com.vishal.store.utils.Constants.SharedPref.USER_LAST_NAME
import com.vishal.store.utils.Constants.SharedPref.USER_NICE_NAME
import com.vishal.store.utils.Constants.SharedPref.USER_PROFILE
import com.vishal.store.utils.Constants.SharedPref.USER_ROLE
import com.vishal.store.utils.Constants.SharedPref.USER_TOKEN
import com.vishal.store.utils.Constants.SharedPref.USER_USERNAME
import com.vishal.store.utils.Constants.SharedPref.WISHLIST_DATA
import com.vishal.store.utils.SharedPrefUtils
